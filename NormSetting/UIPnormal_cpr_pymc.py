...
for jj in range(Num):
    ...
    if jj >= numRes:
        ...
        with NPP_model:
            post_normal_NPP = pm.sample(draws=5000, tune=5000, target_accept=0.8, cores=4, chains=4)
        ...
        with LCP_model:
            post_normal_LCP = pm.sample(draws=5000, tune=5000, target_accept=0.9, cores=4, chains=4)
        ...
        with UIPD_model:
            post_normal_UIPD = pm.sample(draws=5000,tune=5000, target_accept=0.8, cores=4, chains=4)
        ...
        with UIPJS_model:
            post_normal_UIPJS = pm.sample(draws=5000, tune=5000, target_accept=0.8, cores=4, chains=4)
